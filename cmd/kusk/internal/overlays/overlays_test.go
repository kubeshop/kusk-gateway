...
func TestOverlay(t *testing.T) {
	...
	fmt.Println(applyOverlay("/root/go/src/github.com/kubeshop/kusk-gateway/cmd/kusk/internal/overlays/overlay.yaml", "/root/go/src/github.com/kubeshop/kusk-gateway/cmd/kusk/internal/overlays/petstore.yaml"))
