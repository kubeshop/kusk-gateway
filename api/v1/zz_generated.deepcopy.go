...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MethodToRoute) DeepCopyInto(out *MethodToRoute) {
	{
		in := &in
		*out = make(MethodToRoute, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MethodToRoute.
func (in MethodToRoute) DeepCopy() MethodToRoute {
	if in == nil {
		return nil
	}
	out := new(MethodToRoute)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *Route) DeepCopyInto(out *Route) {
	*out = *in
	if in.Backend != nil {
		...
		*out = make([]*options.BackendOptions, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(options.BackendOptions)
				**out = **in
			}
		}
	}
...
func (in *StaticRouteSpec) DeepCopyInto(out *StaticRouteSpec) {
	*out = *in
	...
	if in.Paths != nil {
		...
		*out = make(map[Path]MethodToRoute, len(*in))
		for key, val := range *in {
			var outVal map[HTTPMethod]*RouteAction
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
